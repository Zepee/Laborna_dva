...
void info_out(vector<vector<string>> ,vector<string> &,vector<float>&);
...
int main() {
    ...
    info_out( all_data,names,avg_score);
}
...
void info_out(vector<vector<string>> students,vector<string>& names,vector<float>& avg_score )
{
    int grades;
    int sum;
    vector<string> temp;
